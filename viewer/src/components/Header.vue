...
<template>
  ...
  >
    ...
    <div className="flex items-center gap-5 flex-1 w-4/5">
      ...
      <v-icon name="co-home" />
      <p
        className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600 text-xl"
      >
        Sound Like
      </p>
      <div
        className="flex items-center h-12 w-[420px] px-5 rounded-full border border-gray-600 bg-[#1e1e1e] focus-within:border-2 focus-within:border-white"
      >
